	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    null,
	                    React.createElement('input', { type: 'text', ref: 'loc', placeholder: 'Enter city name' })
	                ),
	                React.createElement(
	                    'div',
	                    null,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=1d55319993e2676cae5afdf5410cdab8&units=Metric';

	module.exports = {
	    getTemp: function getTemp(loc) {
